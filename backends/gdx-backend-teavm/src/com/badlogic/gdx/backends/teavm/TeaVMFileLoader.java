...
import com.badlogic.gdx.backends.teavm.TeaVMFileHandle.FSEntry;
...
public class TeaVMFileLoader {
	...
	private static void loadAll (final TeaVMFilePreloadListener listener) {
		final Queue<Task> tasks = new ArrayDeque<Task>();
	...
	private static void initEntry (FSEntry parent, JSArrayReader<FileDescriptor> descList, String fullPath, Queue<Task> tasks) {
