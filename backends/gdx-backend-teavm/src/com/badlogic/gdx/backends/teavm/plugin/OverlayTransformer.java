...
import com.badlogic.gdx.backends.teavm.emu.*;
...
public class OverlayTransformer implements ClassHolderTransformer {
	...
	public void transformClass (ClassHolder cls, ClassReaderSource innerSource, Diagnostics diagnostics) {
		...
		} else if (cls.getName().equals(VertexArray.class.getName()) || cls.getName().equals(VertexBufferObject.class.getName())) {
	...
	private void transformBufferUtils (ClassHolder cls, ClassReaderSource innerSource) {
		List<MethodDescriptor> descList = new ArrayList<MethodDescriptor>();
	...
	private void transformFileHandle (ClassHolder cls) {
		Set<MethodDescriptor> methodsToRetain = new HashSet<MethodDescriptor>();
		Set<MethodDescriptor> methodsToRetainUnmodified = new HashSet<MethodDescriptor>();
