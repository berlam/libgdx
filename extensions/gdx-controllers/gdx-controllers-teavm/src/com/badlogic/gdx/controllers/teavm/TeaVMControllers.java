...
import com.badlogic.gdx.controllers.teavm.support.Gamepad;
import com.badlogic.gdx.controllers.teavm.support.GamepadSupport;
import com.badlogic.gdx.controllers.teavm.support.GamepadSupportListener;
...
public class TeaVMControllers implements ControllerManager, GamepadSupportListener {
	private final IntMap<TeaVMController> controllerMap = new IntMap<TeaVMController>();
	...
	private final Array<TeaVMControllerEvent> eventQueue = new Array<TeaVMControllerEvent>();
