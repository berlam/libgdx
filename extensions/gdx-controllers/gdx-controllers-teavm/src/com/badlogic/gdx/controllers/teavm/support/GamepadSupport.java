...
public class GamepadSupport {
	...
	@JSBody(script = "return !!navigator.getGamepads || !!navigator.webkitGamepads || !!navigator.webkitGetGamepads;")
	private static native boolean shouldStartPolling ();

	@JSBody(script = "return !!navigator.getGamepads || !!navigator.webkitGetGamepads || "
		+ "!!navigator.webkitGamepads || (navigator.userAgent.indexOf('Firefox/') != -1);")
	private static native boolean isGamepardSupportAvailable ();

	@JSBody(script = "return rawGamepads = (navigator.webkitGetGamepads && navigator.webkitGetGamepads()) || "
